    ...
    <div className='py-16'>
        <div className='w-[80%] mx-auto items-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10'>
            ...
            <div className="space-y-5">
                ...
                <div className='mt-6'>
                    <h1 className='text-sm text-gray-600'>Our Mobil;e Number</h1>
                    <h1 className='text-base font-bold text-blue-950 mt-1'>+91 8888888888</h1>
                </div>
                <div className='mt-6'>
                    <h1 className='text-sm text-gray-600'>Our Email</h1>
                    <h1 className='text-base font-bold text-blue-950 mt-1'>tripy@gmail.com</h1>
                </div>  
            </div>
        </div>
